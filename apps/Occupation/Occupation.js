    ...
    async search_cz(e) {
        ...
        */
        ...
        if (guaiwu == 0) {
            mubiao[i] = {
                名号: "村庄-稻妻",
                赏金: Math.trunc(500 * (1.5 + 0.02 * player.occupation_level) * player.level_id * player.Physique_id / 42 / 42 / 5),
                QQ: 1
            }
            i++;
        } else {
            mubiao[i] = {
                名号: "村庄-蒙德",
                赏金: Math.trunc(500 * (1.5 + 0.03 * player.occupation_level) * player.level_id * player.Physique_id / 42 / 42 / 5),
                QQ: 1
            }
            i++;
        }
